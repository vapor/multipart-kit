...
class MultipartTests: XCTestCase {
    ...
    func testTwilioFile() throws {
        ...
        let res = try FormDataDecoder().decode(TwilioFaxResponse.self, from: data, boundary: "MYPsmgtObKQUblaq4QCe96cd")
        XCTAssertEqual(res.id, "FX0fec397a6dc116ceb6de4e25f9b22583")
        XCTAssertEqual(res.to, "+16137022364")
        XCTAssertEqual(res.from, "+16132287430")
        XCTAssertEqual(res.status, "received")
        XCTAssertEqual(res.file.filename, "fax_FX0fec397a6dc116ceb6de4e25f9b22583_ACd2704344e837aac124a8dbf51eeea485.pdf")
        XCTAssertEqual(res.file.data.count, 12727)
    }
